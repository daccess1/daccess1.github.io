...
var _translations = {
    ...
    ru: {
        ...
        actives: {
            ...
            toast_fail: "Не хватает <img src='https://d25ebjvanew4na.cloudfront.net/static/icon-coin.svg' alt='coin' class='toast--coin'> для улучшения",
    ...
    de: {
        ...
        "actives": {
            ...
            "toast_fail": "Nicht genug <img src='https://d25ebjvanew4na.cloudfront.net/static/icon-coin.svg' alt='Münze' class='toast--coin'> für das Upgrade",
    ...
    fr: {
        ...
        "actives": {
            ...
            "toast_fail": "Pas assez de <img src='https://d25ebjvanew4na.cloudfront.net/static/icon-coin.svg' alt='pièce' class='toast--coin'> pour la mise à niveau",
    ...
    hi: {
        ...
        "actives": {
            ...
            "toast_fail": "अपग्रेड के लिए पर्याप्त <img src='https://d25ebjvanew4na.cloudfront.net/static/icon-coin.svg' alt='सिक्का' class='toast--coin'> नहीं हैं",
    ...
    pt: {
        ...
        "actives": {
            ...
            "toast_fail": "Não há <img src='https://d25ebjvanew4na.cloudfront.net/static/icon-coin.svg' alt='moeda' class='toast--coin'> suficiente para a atualização",
    ...
    th: {
        ...
        "actives": {
            ...
            "toast_fail": "ไม่มี <img src='https://d25ebjvanew4na.cloudfront.net/static/icon-coin.svg' alt='เหรียญ' class='toast--coin'> เพียงพอสำหรับการอัปเกรด",
    ...
    tr: {
        ...
        "actives": {
            ...
            "toast_success": "Aktif başarıyla yükseltildi",
                "toast_fail": "Yükseltme için yeterli <img src='https://d25ebjvanew4na.cloudfront.net/static/icon-coin.svg' alt='madeni para' class='toast--coin'> yok",
    ...
    vi: {
        ...
        "actives": {
            ...
            "toast_fail": "Không đủ <img src='https://d25ebjvanew4na.cloudfront.net/static/icon-coin.svg' alt='đồng xu' class='toast--coin'> để nâng cấp",
